          ...
          <div class="col-xxl-4 col-lg-4 mb-lg-0 mb-5">
            ...
            <div class="customer-info">
              ...
              <div class="customer-card">
                ...
                <?php
                  $sql = "SELECT o.*, u.id as uid, u.first_name, u.last_name, o.order_date, u.city, u.state FROM mas_donuts_wholesale.orders o join useraccounts.wholesale_users u on u.id = o.wholesale_users_id WHERE o.id = '$idoforder'";
                  ...
                  if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                      ...
                      $sql1 = "SELECT * FROM mas_donuts_wholesale.order_item WHERE order_id = '$idoforder'";
                ...
                <tbody>
                  ...
                  if ($result1->num_rows > 0) {
                    while($row1 = $result1->fetch_assoc()) {
                      ...
                      $sql2 = "SELECT * FROM mas_donuts_wholesale.product WHERE id = '$product_id'";
                      // $sql1 = "SELECT o.*, p.id as pid from order_item o join product p on p.id = o.product_id where o.order_id = '$idoforder'";
